...
},{"process":"../../../node_modules/process/browser.js"}],"../../../node_modules/dayjs/plugin/relativeTime.js":[function(require,module,exports) {
var define;
  ...
  _createClass(ChatList, [{
    ...
    value: function drawMessage(_ref) {
      ...
      $message.append((0, _jquery.default)('<span>', {
        ...
        text: (0, _dayjs.default)(t).fromNow()
      }));
      $message.append((0, _jquery.default)('<span>', {
      ...
      $messageRow.append($message); // $(this.listId).append($messageRow); //wrong in book!
    ...
    value: function init() {
      this.timer = setInterval(function () {
        (0, _jquery.default)('[data-time]').each(function (idx, element) {
          ...
          var ago = (0, _dayjs.default)(timestamp).fromNow();
          $element.html(ago);
        });
      }, 1000);
    }
...
},{"dayjs":"../../../node_modules/dayjs/dayjs.min.js","jquery":"../../../node_modules/jquery/dist/jquery.js","dayjs/plugin/relativeTime":"../../../node_modules/dayjs/plugin/relativeTime.js"}],"app.js":[function(require,module,exports) {
"use strict";
